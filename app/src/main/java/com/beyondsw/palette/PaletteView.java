...
public class PaletteView extends View {
    ...
    private void init() {
        ...
        mDrawSize = DimenUtils.dp2pxInt(3);//线宽度
        mEraserSize = DimenUtils.dp2pxInt(30);//橡皮擦
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                if (touchListener != null && mMode == Mode.ERASER) {
                    touchListener.onStart(mEraserSize,event.getRawX(),event.getRawY());
                }
                mLastX = x;
                mLastY = y;
                if (mPath == null) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(mMode==Mode.ERASER && touchListener!=null){
                    touchListener.onTouched(mEraserSize,event.getRawX(),event.getRawY());
                }
                Log.e("--","ACTION_MOVE:x="+x+",y="+y+",size="+mEraserSize);
    ...
    public interface TouchListener{
        void onTouched(int size,float x,float y);
        void onStart(int size,float x,float y);
        void onCancle();
    }
